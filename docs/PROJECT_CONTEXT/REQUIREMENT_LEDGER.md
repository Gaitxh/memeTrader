...
| INFO-003 | 长期总 Prompt §6 | 10s/30s/1m/5m mention velocity、加速度、跨平台扩散 | NOT_STARTED | 当前 attention 为事件级分数，没有完整时序作者/互动轨迹 | 全部 | 是 | 否 | 平台可见性与统一计量困难 | 先定义 append-only 观察 schema 与缺失分母 | 2026-08-31 16:35 |
