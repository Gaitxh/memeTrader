...
- **X/其他社交采集**：平台已登录或账号已在清单中，不等于正在采集。当前 X 仍无 Bridge heartbeat，watch-account exposure 为 0；需要扩展实际连接并保持目标公开页面打开。
...
- 社交桥的“页面心跳 → 账号暴露 → 精确原帖命中 → 事件归因 → 60m 随访 → Paper 结果”完整闭环尚未跑通。
