...
- 结果按平台、信息类型、账号类型、来源、人物实体、事件 topic、Trend Scout lane，以及事件热度/新鲜度、来源组合、公众人物上下文、链、Token 年龄、流动性、市值、成交量、买卖压力、安全状态和拒绝原因展示。只有成熟的 60 分钟人物/平台结果可与成熟账号暴露共同进入 `watch-attention/v1`；其他维度和时间窗保持只观察。
