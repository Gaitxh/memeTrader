...
function liveMetricForFamily(family){
  ...
  return {
    ...
    pendingText:Number(account.unresolved_corrected_position_count||0)>0?'历史成交待核查':'持仓行情待更新',
    pnl,
    open,
    terminal,
    wins,
