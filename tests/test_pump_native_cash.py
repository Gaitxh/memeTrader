...
from memetrader.pump_native_cash import assemble,addresses,PUMP
from test_pump_native import fixed137,fee137,global_config,SOL


def test_cold_final_message_assembler_quotes_actual_resized_messages():
    async def run():
        ...
        def reply(req):
            ...
            if b['method']=='getMultipleAccounts':
                result={'context':{'slot':11},'value':[{'data':[base64.b64encode(bytes(rent)).decode(),'base64']},None,None,account,account]}
