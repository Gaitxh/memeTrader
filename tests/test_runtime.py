...
def test_followup_tick_finalizes_event_and_token_context_with_legacy_quote_lane(tmp_path):
    async def scenario():
        ...
        runtime.store.finalize_missed_opportunity_quality_adjudications = lambda: calls.append("miss_quality")
        ...
        assert calls == [
            ...
            "missed_opportunity", "miss_quality", "no_decision_attribution",
        ]
        await runtime.close()
